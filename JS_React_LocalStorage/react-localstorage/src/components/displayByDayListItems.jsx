const DisplayByDayListItems = ({ 
    ...
    const sortedItems = [...items].sort((a, b) => b.important - a.important);


    /// filtruoja pagal laika 
    const todayItems    = sortedItems.filter(item => item.when === "Today"   );
    const tomorrowItems = sortedItems.filter(item => item.when === "Tomorrow");
    const upcomingItems = sortedItems.filter(item => item.when === "Upcoming");
...
export default DisplayByDayListItems;
